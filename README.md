...
# Полезные материалы по эффективному глубокому обучению и архитектуре LLM

Ниже представлен подбор актуальных и содержательных ресурсов, охватывающих как аппаратные аспекты ускорения вычислений, так и архитектурные особенности современных крупных языковых моделей (LLM).
...
- **Глоссарий по GPU от Modal**  
  ...
  [Читать далее](https://modal.com/gpu-glossary/device-hardware/streaming-multiprocessor)
...
- **Погружение в архитектуру TPU**  
  ...
  [Читать далее](https://henryhmko.github.io/posts/tpu/tpu.html)
...
- **Как работают умножения матриц: техника тайлинга**  
  ...
  [Читать далее](https://alvinwan.com/how-to-tile-matrix-multiplication/)
...
- **Арифметика вывода трансформеров: подсчёт памяти и задержек**  
  ...
  [Читать далее](https://kipp.ly/transformer-inference-arithmetic/)
...
- **UltraScale Playbook от Hugging Face**  
  ...
  [Читать далее](https://huggingface.co/spaces/nanotron/ultrascale-playbook)
...
- **Scaling Book: подход DeepMind к масштабированию на TPU**  
  ...
  [Читать далее](https://jax-ml.github.io/scaling-book/)
...
- **Сравнение современных архитектур LLM (2025)**  
  ...
  [Читать далее](https://magazine.sebastianraschka.com/p/the-big-llm-architecture-comparison)
